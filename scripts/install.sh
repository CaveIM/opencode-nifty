...
---
description: Run the Cave Meister Orchestrator health check
---
...
printf 'Cave Meister Orchestrator instructions: %s\n' "$TARGET_AGENTS_FILE"
printf 'Cave Meister Orchestrator commands: %s/nifty-auth.md, %s/nifty-health.md, %s/nifty-update.md, and %s/nifty-setup.md\n' "$TARGET_COMMAND_DIR" "$TARGET_COMMAND_DIR" "$TARGET_COMMAND_DIR" "$TARGET_COMMAND_DIR"
printf 'Restart OpenCode before running /nifty-auth so it loads Cave Meister Orchestrator.\n'
