/**
 * Claude Opus 4.7-native Denny prompt - tuned for Opus 4.7 behaviors.
 *
...
export declare function buildClaudeOpus47DennyPrompt(model: string, availableAgents: AvailableAgent[], availableTools?: AvailableTool[], availableSkills?: AvailableSkill[], availableCategories?: AvailableCategory[], useTaskSystem?: boolean): string;
