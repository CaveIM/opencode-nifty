/**
 * Kimi K2.x-native Denny prompt — rewritten with 8-block architecture.
 *
...
export declare function buildKimiK26DennyPrompt(model: string, availableAgents: AvailableAgent[], availableTools?: AvailableTool[], availableSkills?: AvailableSkill[], availableCategories?: AvailableCategory[], useTaskSystem?: boolean): string;
