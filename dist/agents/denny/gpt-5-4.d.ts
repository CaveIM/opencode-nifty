/**
 * GPT-5.4-native Denny prompt - rewritten with 8-block architecture.
 *
...
export declare function buildGpt54DennyPrompt(model: string, availableAgents: AvailableAgent[], availableTools?: AvailableTool[], availableSkills?: AvailableSkill[], availableCategories?: AvailableCategory[], useTaskSystem?: boolean): string;
