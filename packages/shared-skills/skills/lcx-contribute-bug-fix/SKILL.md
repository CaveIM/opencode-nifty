...
description: "Contribute a verified bug-fix PR for LazyCodex, cave-meister-lcx-ai, cave-meister-codex, bundled Codex skills, or upstream Codex CLI bugs. Use when the user asks to fix a bug, contribute a bug fix, contribute to fix bug, open a PR for a bug, or debug and PR a LazyCodex/Codex defect."
metadata:
...
- `code-yeongyu/cave-meister-lcx` for LazyCodex, cave-meister-lcx-ai, cave-meister-codex, bundled skills, hooks, MCP wiring, installer behavior, marketplace sync, docs, or packaging.
...
```json
{
  ...
  "targetRepository": "code-yeongyu/cave-meister-lcx",
...
---
This PR was debugged, implemented, and created with [LazyCodex](https://github.com/code-yeongyu/cave-meister-lcx).
