...
export function shouldDisablePostHog() {
    return (isDisableFlag(process.env["CAVE_MEISTER_DISABLE_POSTHOG"]) ||
        isTelemetryOptOutFlag(process.env["CAVE_MEISTER_SEND_ANONYMOUS_TELEMETRY"]) ||
        isDisableFlag(process.env["CAVE_MEISTER_CODEX_DISABLE_POSTHOG"]) ||
        isTelemetryOptOutFlag(process.env["CAVE_MEISTER_CODEX_SEND_ANONYMOUS_TELEMETRY"]));
}
