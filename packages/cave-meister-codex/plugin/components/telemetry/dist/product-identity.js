...
export const PRODUCT_NAME = "cave-meister-codex";
export const PACKAGE_NAME = "@cave-meister/cave-meister-codex";
export const CACHE_DIR_NAME = "cave-meister-codex";
export const EVENT_NAME = "cave_meister_codex_daily_active";
export const LEGACY_PARENT_PACKAGE = "cave-meister";
